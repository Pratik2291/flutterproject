...
class ListCinemaScreen extends StatefulWidget {
  ...
  const ListCinemaScreen({Key? key, required this.model, required this.cinemaname}) : super(key: key);
  final cinemaname;
          ...
          itemBuilder: (_, index) {
            return Container(
              ...
              child: TheatreBlock(
                ...
                onTimeTap: (index) {
                  Get.to(() => SeatSelectionScreen(theatreModel: theatres[0], movieModel: widget.model));
                },
              ),
            );
          },
